...
const Header = (props) => {
  const { headerClass, headerLogo } = props;
                ...
                <div className="ed-header-top-left text-center text-md-start">
                  <ul>
                    <li className="d-none d-xxl-inline-block">
                      ...
                      <a className="hover-anim" href="tel:(+212)524433170">
                        (+212) 524 43 31 70
                      </a>
                    </li>
                    <li>
                      ...
                      <a
                        ...
                        href="mailto:contact@fstg-marrakech.com"
                      >
                        contact@fstg-marrakech.com
                      </a>
                    </li>
                    <li className="d-none d-xxl-inline-block">
                      <i>
                      ...
                      <a
                        className="hover-anim"
                        href="https://maps.app.goo.gl/be7cBPBNtqC8725XA"
                        target="_blank"
                      >
          ...
          <div className="container">
            <div className="ed-header-wrapper p-relative">
              <div className="row align-items-center">
                <div
                  className="col-xxl-2 col-xl-1 col-lg-2 col-lg-5 col-md-5 col-5 col-sm-3"
                ...
                <div className="col-xxl-6 col-xl-7 col-lg-6 d-none d-xl-block">
                  <div className="ed-header-main-menu it-main-menu">
                    <nav className="it-menu-content">{<MenuItems />}</nav>
                  </div>
                </div>
                <div className="col-xxl-3 col-xl-3 col-lg-1 col-lg-2 col-md-1 col-8 col-sm-2">
                  <div className="ed-header-button d-flex justify-content-end align-items-center">
                    <div className="d-none d-md-block">
                      <Link className="ed-btn-theme" to="/signin">
                        Se Connecter
                        <i>
                          <RightArrow />
                        </i>
          ...
          <div className="itoffcanvas__info">
            ...
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              ...
              <div className="itoffcanvas__info-address">
                <span>Email</span>
                <a href="maito:contact@fstg-marrakech.com">
                  contact@fstg-marrakech.com
                </a>
              </div>
            </div>
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              ...
              <div className="itoffcanvas__info-address">
                <span>Phone</span>
                <a href="tel:(+212) 524 43 31 70">(+212) 524 43 31 70</a>
              </div>
            </div>
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              <div className="itoffcanvas__info-icon">
