...
import aboutImg2 from "../../assets/img/about/about_Etudiant_fst.JPG";
import aboutImg3 from "../../assets/img/about/aboutFst2.jpg";
import aboutImg4 from "../../assets/img/about/fst1.jpg";
          ...
          >
            <div className="it-about-right-box">
              {/*     <SectionTitleSpecial
                ...
                preTitle="A propos de notre Établissement"
                // highlightText=""
                //  postTitle=""
              />*/}
              <h1 className="it-choose-title-box mb-30">
